...
exports.mixInTo = function (mixee) {
  ...
  INJECTED_PROPERTIES.forEach(function (propertyName) {
    if (!mixee[propertyName]) {
      throw new TypeError('Notification Calls can only be mixed in to an object with a ' +
...
exports.getNotificationsUpTo = function (maxNotifications, callback) {
  var notificationsPath =
    this.pathMapper.getNotificationsPathUpTo(maxNotifications);
