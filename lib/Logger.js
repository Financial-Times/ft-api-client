...
var STATUS_MESSAGE_PREFIX = 'FT API Response: ',
  TEMP_FAILURE_MESSAGE = 'FT API: Request to\n  {0}\ntemporarily failed. Retrying...',
  FAILURE_MESSAGE = 'FT API: Request to\n  {0}\nfailed after {1} retries.',
...
MESSAGES_BY_STATUS_CODE = {
  ...
  429: STATUS_MESSAGE_PREFIX + '429: Requests are more rapid than the API key allowance',
...
Logger.prototype.logResponse = function (statusCode) {
  var message = MESSAGES_BY_STATUS_CODE[statusCode],
    // Log non-200s as response errors
    level = statusCode === 200 ? Logger.LOG_LEVEL_INFO : Logger.LOG_LEVEL_ERROR;
