...
function onResponse (resolve, reject, err, response, body) {
    ...
    if (err) {
        ...
        return reject(new CapiError(503, err, endpoint));
    }
    ...
    if (response.statusCode >= 400) {
        ...
        return reject(new CapiError(response.statusCode, err, endpoint));
    }
    ...
    try {
        ...
        return reject(new CapiError(503, 'error parsing JSON', endpoint));
    }
...
function complexSearch(requestBody){
    ...
    return new Promise(function(resolve, reject){
        ...
        request.post({
            ...
            return onResponse(resolve, reject, err, response, body);
        })
    }).catch(function (err) {
